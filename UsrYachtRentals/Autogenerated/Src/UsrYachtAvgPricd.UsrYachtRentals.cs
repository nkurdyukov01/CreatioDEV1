namespace Terrasoft.Core.Process
{
	...
	#region Class: UsrYachtAvgPricdMethodsWrapper

	/// <exclude/>
	public class UsrYachtAvgPricdMethodsWrapper : ProcessModel
	{

		public UsrYachtAvgPricdMethodsWrapper(Process process)
			: base(process) {
